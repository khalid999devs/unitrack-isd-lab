        ...
        <section class="rounded-2xl border border-border-soft bg-card-bg p-6 shadow-card">
            <div class="flex items-center gap-4">
                <div class="flex min-w-0 items-center gap-4">
                    <div class="flex h-20 w-20 shrink-0 items-center justify-center rounded-2xl bg-indigo-accent text-2xl font-bold text-on-primary shadow-lg shadow-indigo-accent/20">
                        {{ $teacherInitials }}
                    </div>
                    <div class="min-w-0">
