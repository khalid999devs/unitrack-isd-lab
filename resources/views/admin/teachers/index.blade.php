...
@section('content')
    <div class="space-y-6">
        <section class="flex flex-col gap-4 rounded-2xl border border-border-soft bg-card-bg p-5 shadow-card sm:flex-row sm:items-center sm:justify-between">
            <div>
                <p class="text-sm font-bold text-main-text">Teacher directory</p>
                <p class="text-sm text-secondary-text">Manage profiles, accounts, and departmental allocations.</p>
            </div>
            <div>
